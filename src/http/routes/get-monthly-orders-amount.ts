...
export const getMonthlyOrdersAmount = (app: Elysia) => {
  app
    .use(auth)
    .get('/metrics/monthly-orders-amount', async ({ getLoggedInUser }) => {
      ...
      const currentMonthlyOrdersAmount = ordersPerMonth.find(orderPerMonth => {
